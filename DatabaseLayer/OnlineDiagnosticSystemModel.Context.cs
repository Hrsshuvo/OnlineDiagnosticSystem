...
namespace DatabaseLayer
{
    ...
    public partial class OnlineDiagnosticLabSystemDbEntities5 : DbContext
    {
        public OnlineDiagnosticLabSystemDbEntities5()
            : base("name=OnlineDiagnosticLabSystemDbEntities5")
        {
        }
